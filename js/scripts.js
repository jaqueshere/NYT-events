...
var getEvents = function(location, map, radius, date_range) {
	...
	if (zip_pattern.test(location)) {
		url = 'https://dev.virtualearth.net/REST/v1/Locations?postalCode=' + location + '&key=Ascxy1k6vRhXRU8R5rOchA5dZvvGww07N2vEsg4KiMjYWkV_ni4-EtjLW2xNlzXf' + '&s=1';
	}
	else {
		url = 'https://dev.virtualearth.net/REST/v1/Locations?locality="New York City"&addressLine=' + location + '&key=Ascxy1k6vRhXRU8R5rOchA5dZvvGww07N2vEsg4KiMjYWkV_ni4-EtjLW2xNlzXf' + '&s=1';		
	}
